...
| |\  |  __/>  <| \__ \ |_| | | | (_) | | | |   | |  __/>  <| |_| |  __/ |_) |
|_| \_|\___/_/\_\_|___/\__|_| |_|  ___/|_| |_|   |_|\___/_/\_\\__|_\\___|_.__/ 
...
"Let's call it the Star Core," Aria suggested, "because its energy characteristics are similar to a stellar core.")";
    ...
    try {
        ...
        app.set_progress_callback([](int progress, const std::string& message) {
...
void generate_text() {
    ...
    try {
        ...
        auto future = app.generate_text(tensor, mode);
